      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8">
          {testimonials.map((testimonial, index) => (
            ...
            >
              <div className="relative glass-card p-8 hover:border-indigo-500/30 transition-all duration-300 h-full">
                {/* Quote Icon */}
                <div className="absolute top-8 right-8 text-indigo-500/10">
